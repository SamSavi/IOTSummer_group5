...
# --- LCD Auto-refresh thread ---
# Shared state
lcd_mode = "auto"   # "auto", "temp", "dist", "text"
lcd_custom_text = ""
...
<head>
  ...
  <style>
    ...
    input[type=text] {{ padding:8px; border-radius:6px; border:none;
                        width:200px; font-size:1em; margin:6px; }}
  </style>
</head>
<body>
  <h1>🌐 ESP32 IoT - Task 3</h1>
...
# Start LCD thread in background
